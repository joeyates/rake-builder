...
This problem is mostly felt in testing, where modfication times are modified
to test dependencies. As a workaround, tests wait for second to complete between building
and updating dependencies' modification times.
...
* reset modified mtime after dependencies spec
* install task
