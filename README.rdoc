...
http://github.com/downloads/joeyates/rake-builder/rake-cppDependencies.png
...
* re-factor config loader into separate class 
* Only look for sources, etc when compiling
